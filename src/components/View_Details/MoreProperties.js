...
<div className='item ' data-value={item.id} key={item.id}>
      <div className='card object-fit-fill border  rounded-4 h-50'>
        ...
        <div className='row fw-lighter'>
            ...
            <div className='col-12 d-flex justify-content-between align-items-center'>
              ...
              <NavLink  to="/Popular_Details" type="button" className="btn btn-primary mb-0 px-2">View Details</NavLink>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className='container mt-5 bg-white shadow-sm rounded-4'>
      <div className='row'>
      <div className='d-flex flex-wrap align-items-center mb-2'>
          <div className='fs-3 flex-grow-1 d-flex'>
            <div className='d-flex justify-content-around'>
            <p className='ms-3'> See More Properties</p>
