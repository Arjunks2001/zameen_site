...
<div className='container mt-5 mb-5 '>
      <div className='row justify-content-center '>
        <div className='col-md-10 d-none d-md-inline'>
   ...
   <div class = "card-img-overlay mt-lg-5 ">
    ...
    <div className='col-lg-5 d-flex ms-5 '>
    <input type="text" class="form-control me-3" placeholder="Enter your email address" aria-label="Username" aria-describedby="basic-addon1"/>
